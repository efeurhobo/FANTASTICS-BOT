...
const config = {
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || '✅️ Status Viewed by FANTASTICS-BOT,
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "255749750707",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "255628871373,254742063632",
